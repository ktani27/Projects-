...
# Create the extract() function with two parameters: one for the store data and the other one for the extract the data
# Read the extracted data from the parquet file and merge the DataFrames using "index" column
